"""
🍝 YamieBot - Gradio Frontend (Connected to FastAPI Backend)

This version connects to the FastAPI backend via HTTP requests.
The backend handles all the logic - Gradio is just the UI.
...
demo = gr.ChatInterface(
    ...
    description="Ask me anything about Yamie PastaBar! (Dutch or English)",
    examples=[
...
if __name__ == "__main__":
    ...
    print("  2. Open your browser at: http://localhost:7860")
    print("  3. Ask questions and test!")
    print("\n💡 Architecture:")
    print("  Gradio (localhost:7860) → FastAPI (localhost:8000) → QueryEngine")
    print("\n" + "="*80 + "\n")
